...
const ISOActions: actionType = {
	...
	getConfigPath: {
		description: 'getConfig path',
		shortDescription: 'getConfigPath',
...
const Actions: actionType = {
	...
	CustomCommand: {
		...
		shortDescription: 'CustomCommand',
	...
	CustomCommandWithArguments: {
		description: 'Custom w/args',
		shortDescription: 'CustomCommandWithArguments',
		command: '/customCommandWithArguments',
		args: ['path', 'customArgs'],
		singleUser: null,
		type: 'Special',
	},
}
if (module != undefined) module.exports = { Actions, ISOActions }
