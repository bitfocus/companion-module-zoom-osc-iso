...
const GlobalActions = {
	MuteAll: { description: 'User Action: Mute All', shortDescription: 'Mute All', command: '/zoom/all/mute' },
	UnmuteAll: { description: 'Global Action: Unmute All', shortDescription: 'Unmute All', command: '/zoom/all/unMute' },
	ClearSpotlight: {
	...
	DeleteAllBreakoutRooms: {
		...
		shortDescription: 'Delete All BreakoutRooms',
	...
	BroadcastMessageToBreakoutRooms: {
		...
		shortDescription: 'Broadcast Message To BreakoutRooms',
