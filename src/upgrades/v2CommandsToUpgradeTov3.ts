...
import {
	...
	oldFeedbackTypeToNewFeedbackType,
...
export function UpgradeV2ToV3(
	...
	for (const action of actions) {
		if (
			...
			const oldActionToNewAction = oldActionToNewActions[action.actionId]
			action.actionId = oldActionToNewAction.newActionId
	...
	for (const feedback of feedbacks) {
		if (Object.prototype.hasOwnProperty.call(oldFeedbackToNewFeedbacks, feedback.feedbackId)) {
			const oldFeedbackToNewFeedback = oldFeedbackToNewFeedbacks[feedback.feedbackId]
...
export const oldActionToNewActions: oldActionToNewAction = {
	Spotlight: {
...
export const oldFeedbackToNewFeedbacks: oldFeedbackToNewFeedback = {
	selectionMethod: {
...
export const oldFeedbackTypeToNewFeedbackTypes: oldFeedbackTypeToNewFeedbackType = {
	selected: {
